...
This was synthesized using IIC-OSIC-TOOLS and with the open source SKY130 PDK. To run the synthesized version, run ./cvcsim.  To rerun the simulation, check out temp.sh
