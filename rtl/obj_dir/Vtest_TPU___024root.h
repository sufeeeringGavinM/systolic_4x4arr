...
#ifndef VERILATED_VTEST_TPU___024ROOT_H_
#define VERILATED_VTEST_TPU___024ROOT_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) Vtest_TPU___024root final : public VerilatedModule {
  public:
    // CELLS
    Vtest_TPU___024unit* __PVT____024unit;
    ...
    // CONSTRUCTORS
    Vtest_TPU___024root(Vtest_TPU__Syms* symsp, const char* v__name);
    ~Vtest_TPU___024root();
    VL_UNCOPYABLE(Vtest_TPU___024root);
