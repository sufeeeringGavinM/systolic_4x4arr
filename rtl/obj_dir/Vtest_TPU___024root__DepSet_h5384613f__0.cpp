...
void Vtest_TPU___024root___eval_triggers__act(Vtest_TPU___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_TPU___024root___eval_triggers__act\n"); );
    // Body
...
VL_INLINE_OPT void Vtest_TPU___024root___nba_sequent__TOP__0(Vtest_TPU___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtest_TPU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtest_TPU___024root___nba_sequent__TOP__0\n"); );
    // Body
